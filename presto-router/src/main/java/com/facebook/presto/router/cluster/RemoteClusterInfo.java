        ...
        extends RemoteState
{
    ...
    public RemoteClusterInfo(HttpClient httpClient, URI remoteUri, RouterConfig routerConfig, RemoteStateConfig remoteStateConfig)
    {
        super(httpClient, remoteUri, routerConfig, remoteStateConfig);
    }
